''' All L0 data is written with a CCSDS header. This script creates the CCSDS header
    ...
    the CCSDS header parameters in the XTCE file. This is a CoDICE standard used for every packet.
    '''
...
tree.write("CCSDS_pkt.xml", encoding="utf-8", xml_declaration=True)
