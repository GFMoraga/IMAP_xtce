...
sheet_name = "P_COD_LO_NSW_SPECIES_COUNTS"  # Assuming the sheet name is correct
...
root.attrib["name"] = "P_COD_LO_NSW_SPECIES_COUNTS"
...
tree.write("P_COD_LO_NSW_SPECIES_COUNTS.xml", encoding="utf-8", xml_declaration=True)