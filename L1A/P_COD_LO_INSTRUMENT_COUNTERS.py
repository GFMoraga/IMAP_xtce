...
sheet_name = "P_COD_LO_INSTRUMENT_COUNTERS"  # Assuming the sheet name is correct
...
root.attrib["name"] = "P_COD_LO_INSTRUMENT_COUNTERS"
...
tree.write("P_COD_LO_INSTRUMENT_COUNTERS.xml", encoding="utf-8", xml_declaration=True)