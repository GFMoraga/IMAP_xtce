...
sheet_name = "P_COD_HI_SECT_SPECIES_COUNTS"  # Assuming the sheet name is correct
...
tree.write("P_COD_HI_SECT_SPECIES_COUNTS.xml", encoding="utf-8", xml_declaration=True)